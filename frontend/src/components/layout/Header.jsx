...
const Header = ({ onOpenSidebar }) => {
  ...
  return (
    <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-40" data-testid="header">
      <div className="px-3 sm:px-6 h-16 flex items-center justify-between gap-4">
        <div className="min-w-0 flex-1 flex items-center gap-3">
          <button
            onClick={onOpenSidebar}
            className="lg:hidden h-10 w-10 shrink-0 flex items-center justify-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
